...
function showProducts(product) {
  ...
  document.querySelector(".shop-button").setAttribute("data-id", product._id);
  ...
  document.querySelector(".productImage").src =
    "https://annadalsgaard.dk/img/" + product.color[0] + product.basename;
...
const otherProducts =
  "https://silfen-9520.restdb.io/rest/products?q={%22_id%22:{%22$not%22:%22" +
  productId +
  "%22}}&max=4";
const options = {
  headers: {
